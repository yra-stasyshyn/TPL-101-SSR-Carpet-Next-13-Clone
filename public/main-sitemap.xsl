		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
			Generated by <a href="%DOMAIN%" target="_blank" rel="noopener">
					%CITY_NAME% Towing Service
			...
			You can find more information about XML sitemaps on <a href="https://sitemaps.org" target="_blank" rel="noopener">sitemaps.org</a>.
				...
				<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
					<p class="expl">
				This XML Sitemap Index file contains <xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/>
 sitemaps.
					</p>
